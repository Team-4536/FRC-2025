...
class RobotHAL:
    def __init__(self) -> None:
        ...
        self.turnmotorFl = rev.SparkMax(1, rev.SparkLowLevel.MotorType.kBrushless)
        self.turnmotorFR = rev.SparkMax(3, rev.SparkLowLevel.MotorType.kBrushless)
        self.turnmotorBR = rev.SparkMax(7, rev.SparkLowLevel.MotorType.kBrushless)
        self.turnmotorBL = rev.SparkMax(5, rev.SparkLowLevel.MotorType.kBrushless)
