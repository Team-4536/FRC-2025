...
from pathplannerlib import path
...
def generateTrajectory(self, pathFile):
    path = PathPlannerPath.fromPathFile(pathFile)
    
    myTraj = path.generateTrajectory()
    return myTraj
...
class followTrajectory(AutoStage):
